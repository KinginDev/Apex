                ...
                <section class="testimonial-section">
                    ...
                    <div class="overlay overlay-four">
                        <div class="section-common-space">
                            ...
                            <div class="testimonial-slider styled-paginantion colorsch-black" data-action="testimonialSlider">

                                <!-- start single testimonial -->
                                <div class="text-center single-testimonial wow fadeIn" data-wow-duration="1s">
                                ...
                                <div class="text-center single-testimonial">
                                    ...
                                    <!-- start testimonial thumbnail -->
                                    <div class="recomenders-thumb">
                                        <img src="img/testimonial/03.png" alt="">
                                    </div>
                                    <!-- end testimonial thumbnail -->
                                ...
                                <div class="client-slider" data-action="clientSlider">
                                    <div class="col-sm-3">
                                        <div class="single-clients">
                                            <img src="/img/clients/bow.png" alt="Client Logo" style="width: 100px !important; height: 70px !important;">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="single-clients">
                                            <img src="/img/clients/kareer.png" alt="Client Logo" style="width: 100px !important; height: 70px !important;">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="single-clients">
                                            <img src="/img/clients/soca.jpg" alt="Client Logo" style="width: 100px !important; height: 70px !important;">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="single-clients">
                                            <img src="/img/clients/verifi.png" alt="Client Logo" style="width: 100px !important; height: 70px !important;">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="single-clients">
                                            <img src="/img/clients/wmm.png" alt="Client Logo" style="width: 100px !important; height: 70px !important;">
                                        </div>
                                    </div>
<!--
                                    <div class="col-sm-3">
